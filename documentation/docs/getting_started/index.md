...
=== "Linux"
    ...
    | -------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------- |
    | Any Linux         | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-Linux-musl-x86_64.tar.gz)    | x86_64-unknown-linux-musl |
    | Raspberry Pi 3  | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-Linux-musleabi-armv7.tar.gz) | armv7-unknown-linux-musleabi |
    | Raspberry Pi Zero 2 | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-Linux-musleabi-arm.tar.gz) | arm-unknown-linux-musleabi |
    ...
    1. Download and extract the archive and place the ubihome executable in a directory of your choice.
        ...
        ```bash
        curl -L -o ubihome.tar.gz https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-Linux-musleabi-armv7.tar.gz
...
=== "Windows"
    ...
    | -------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------- |
    | Windows 11        | [ZIP Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-Windows-msvc-x86_64.zip)    | x86_64-pc-windows-msvc |
    ...
    ```powershell
    Invoke-WebRequest -OutFile ubihome.zip -Uri https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-Windows-msvc-x86_64.zip
...
=== "MacOS"
    ...
    | Device         | Download                                                                                                          | Target                       |
    | -------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------- |
    | MacOS        | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.8/ubihome-macOS-x86_64.tar.gz)    | x86_64-apple-darwin |

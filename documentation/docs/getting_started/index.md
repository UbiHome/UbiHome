...
=== "Linux"
    ...
    | -------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------- |
    | Any Linux         | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.7/ubihome-Linux-musl-x86_64.tar.gz)    | x86_64-unknown-linux-musl |
    ...
    | Raspberry Pi Zero 2 | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.8.7/ubihome-Linux-musleabi-arm.tar.gz) | arm-unknown-linux-musleabi |

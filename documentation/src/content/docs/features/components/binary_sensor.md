...
| Filter | Description |
| --- | --- |
| [`invert`](./filters#invert) | Inverts the boolean value (`true` <-> `false`). |
| [`delayed_on`](./filters#delayed_on) | Delays propagation of `true` values by the configured duration. |
| [`delayed_off`](./filters#delayed_off) | Delays propagation of `false` values by the configured duration. |

## Supported Platforms

| Platform | Notes |
| --- | --- |
| [Shell](../platforms/shell) | Reads boolean state from command output. |
| [GPIO](../platforms/gpio) | Reads binary state from GPIO pin events. |

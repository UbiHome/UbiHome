...
| Platform | Notes |
| --- | --- |
| [Shell](../platforms/shell) | Uses `command_on` and `command_off`; optional `command_state` for state polling. |
...
For full shell switch setup, see [Shell platform documentation](../platforms/shell#switch).

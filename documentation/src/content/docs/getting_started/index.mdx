...
<Tabs>
  <TabItem label="Linux" icon="linux" mark={labels}>
    ...
    1. Download and extract the archive and place the ubihome executable in a directory of your choice.
       ...
       | ARMv7 Linux / Raspberry Pi 3 (GNU/glibc)      | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.14.0/ubihome-Linux-gnueabihf-armv7.tar.gz)     | armv7-unknown-linux-gnueabihf  |
       | ARMv7 Linux / Raspberry Pi 3 (musl)           | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.14.0/ubihome-Linux-musleabi-armv7.tar.gz)      | armv7-unknown-linux-musleabi   |
       | ARM Linux / Raspberry Pi (generic arm, GNU)   | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.14.0/ubihome-Linux-gnueabi-arm.tar.gz)         | arm-unknown-linux-gnueabi      |
       | ARM Linux / Raspberry Pi (generic arm, musl)  | [TAR Link](https://github.com/UbiHome/UbiHome/releases/download/v0.14.0/ubihome-Linux-musleabi-arm.tar.gz)        | arm-unknown-linux-musleabi     |
       ...
       > Choose the GNU/glibc Linux ARM build when you need shared ALSA plugins such as PulseAudio or PipeWire (`pulse`, `default`, etc.). Choose the musl build for a more self-contained binary when direct ALSA devices such as `hw:0,0` or `plughw:0,0` are sufficient.
